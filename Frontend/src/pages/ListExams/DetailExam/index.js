...
//           onSuccess: () => {
//             console.log(
//               "Cập nhật highest_point thành công, giờ cập nhật score..."
//             );
//           },
//           onError: (error) => {
...
//       );
//     }
//     const timeTakenInSeconds = Math.floor((Date.now() - startTime) / 1000); // Tính số giây làm bài
...
//   }, [detailExam, answerOfUser, id, updateExam, submitQuiz, api]);
...
//   }, [isActive, startTimer, isSubmited, handleSubmitExam]); // Đã thêm handleSubmitExam
...
//         {/* Chỉ hiển thị số câu đúng khi đã bắt đầu làm bài */}
//         {isSubmited && score !== null && (
//           <div>
//             <h2>Số câu trả lời đúng</h2>
//             <h1>
//               {score}/{detailExam.questions.length || 0}
//             </h1>
//           </div>
//         )}
//       </section>

//       {/* Danh sách câu hỏi (chỉ hiển thị khi bài thi đã bắt đầu) */}
//       {
//         <section className="questions-section">
//           {detailExam.questions?.map((question, index) => {
//             const correctIndex = question.correctAnswer.charCodeAt(0) - 65; // Chuyển "A" -> 0, "B" -> 1, ...
//             const userAnswer = answerOfUser[index];
...
//                         let answerStyle = {}; // Mặc định màu đen
...
//                             answerStyle = { color: "red", fontWeight: "bold" }; // Đáp án sai của user: màu đỏ
//                           }
//                         }
